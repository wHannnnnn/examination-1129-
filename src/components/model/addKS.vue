  	...
  	<el-dialog
	    ...
	    :before-close="handleClose">
	      <div class='SJXQ'>
			<el-row :gutter="40">
				<el-col :span="7">
				    <el-select v-model="SJdata" filterable multiple placeholder="选择试卷">
	    ...
	    <span slot="footer" class="dialog-footer">
	      <el-button type="primary" v-if="!changeYL" @click="clickAddKS">添 加</el-button>
	      <el-button type="primary" v-if="changeYL" @click="clickChange">修 改</el-button>
	    </span>
	  </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    clickChange:function(){
        ...
        console.log(oldStudent,this.checkedStudentData,oldJudges,this.valuePSRY,898989)
    	var param ={
	        ...
	        pdgz:this.pdgz,
	        delPapers:delPapers,
	        delStus:this.changeData(oldStudent,this.checkedStudentData),
	        delJudges:this.changeData(oldJudges,this.valuePSRY),
	        delChief:this.oldKSdata.chiefTeacher.mysqlID,
	        addPapers:this.SJdata,
	        addStus:this.changeData(this.checkedStudentData,oldStudent),
	        addJudges:this.changeData(this.valuePSRY,oldJudges),
	        addChief:this.ZSR,
	        Papers:Papers,
	    }
